...
class TestMarkdownPy(unittest.TestCase):
    ...
    def test_hash1(self):
        ...
        '''
        self.assertEqual(
                run_markdown('#this should have <h1> around it'),
                '<h1>this should have <h1> around it</h1>')
    ...
    def test_hash2(self):
        ...
        '''
        self.assertEqual(
                run_markdown('##this should have <h2> around it'),
                '<h2>this should have <h2> around it</h2>')
    ...
    def test_hash3(self):
        ...
        '''
        self.assertEqual(
                run_markdown('###this should have <h3> around it'),
                '<h3>this should have <h3> around it</h3>')
